const menu = [
  ...
  { id: 14, title: "Caesar Salad", category: "starters", price: "$6", description: "Fresh romaine lettuce with Caesar dressing, parmesan, and croutons", img: "https://images.unsplash.com/photo-1550304943-4f24f54ddde9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Y2Vhc2FyJTIwc2FsYWR8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60" },
  { id: 15, title: "Grilled Salmon", category: "mains", price: "$15", description: "Fresh salmon fillet grilled to perfection, served with lemon and herbs", img: "https://images.unsplash.com/photo-1586190848861-99aa4a171e90?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=60" },
...
// function to functionalize search bar

function searchMenu(query) {
  const filteredMenu = menu.filter(item => item.title.toLowerCase().includes(query.toLowerCase()));
  displayMenuItems(filteredMenu);
}
